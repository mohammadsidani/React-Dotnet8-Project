...
public class BasketController : BaseApiController
{
    ...
    public async Task<ActionResult> AddItemToBasket(int productId, int quantity = 1)
    {
        ...
        return BadRequest(new ProblemDetails { Title = "There is a problem saving item to basket" });
    }
    ...
    public async Task<ActionResult> RemoveBasketItem(int productId, int quantity = 1)
    {
        ...
        return BadRequest(new ProblemDetails { Title = "There is a problem removing item from the basket" });
    }
